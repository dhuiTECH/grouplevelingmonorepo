...
import { ReferenceImage, Resolution, StyleStrength, AssetType, SkillType, ModelType } from "../types/mapGenTypes";
...
const getApiKey = (providedKey?: string): string | undefined => {
  ...
  if (typeof process !== 'undefined' && process.env) {
    return process.env.API_KEY || process.env.GEMINI_API_KEY || process.env.NEXT_PUBLIC_GEMINI_API_KEY;
  }
  return undefined;
};
